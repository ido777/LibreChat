...
// קובץ קוד עמוק התעלם HardcodedNonCryptoSecret: אין סודות מקודדים בקובץ זה
    ...
    com_sidepanel_assistant_builder: 'עוזר בונה',
    com_sidepanel_attach_files: 'צרף קבצים',
    com_assistants_knowledge: 'ידע',
    com_assistants_knowledge_info:
      'אם אתה מעלה קבצים תחת ידע, שיחות עם ה-Assistant שלך עשויות לכלול תוכן קובץ.',
    com_assistants_knowledge_disabled:
      'יש ליצור מסייע, ויש להפעיל ולשמור את מתורגמן קוד או אחזור לפני העלאת קבצים כ- Knowledge.',
    com_assistants_code_interpreter: 'מתורגמן קוד',
    com_assistants_code_interpreter_files:
      'הקבצים הבאים זמינים רק עבור מתורגמן קוד:',
    ...
    com_assistants_name_placeholder: 'אופציונלי: שם העוזר',
    com_assistants_instructions_placeholder: 'הוראות המערכת שהעוזר משתמש בהן',
    com_assistants_description_placeholder: 'אופציונלי: תאר את ה-Assistant שלך כאן',
    com_assistants_actions_disabled: 'עליך ליצור מסייע לפני הוספת פעולות.',
    com_assistants_update_success: 'עודכן בהצלחה',
    com_assistants_update_error: 'אירעה שגיאה בעדכון העוזר שלך.',
    com_assistants_create_success: 'נוצר בהצלחה',
    com_assistants_create_error: 'אירעה שגיאה ביצירת העוזר שלך.',
    com_ui_attach_error_type: 'סוג קובץ לא נתמך עבור נקודת קצה:',
    com_ui_attach_error_size: 'חרגת ממגבלת גודל הקובץ עבור נקודת הקצה:',
    com_ui_attach_error:
      'לא ניתן לצרף קובץ. צור או בחר שיחה, או נסה לרענן את הדף.',
    ...
    com_ui_chats: 'צאטים',
    com_ui_assistant: 'עוזר',
    com_ui_delete: 'מחק',
    com_ui_create: 'צור',
    com_ui_delete_conversation: 'למחוק את הצאט?',
    com_ui_delete_conversation_confirm: 'זה ימחק',
    com_ui_delete_assistant_confirm:
      'האם אתה בטוח שאתה רוצה למחוק את האסיסטנט הזה? אי אפשר לבטל את זה.',
      _ui_preview: 'תצוגה מקדימה',
      com_ui_upload: 'העלה',
      com_ui_connect: 'התחבר',
      com_auth_error_login:
        'לא ניתן להתחבר עם המידע שסופק. אנא בדוק את האישורים שלך ונסה שוב.',
      com_auth_error_login_rl:
        'יותר מדי ניסיונות כניסה בזמן קצר. בבקשה נסה שוב מאוחר יותר.',
      com_auth_error_login_ban:
        'החשבון שלך נאסר באופן זמני עקב הפרות של השירות שלנו.',
      com_auth_error_login_server:
        'הייתה שגיאת שרת פנימית. אנא המתן מספר רגעים ונסה שוב.',
      ...
      com_auth_email: 'אימייל',
      com_auth_email_required: 'נדרשת דוא"ל',
      com_auth_email_min_length: 'אימייל חייב להיות בן 6 תווים לפחות',
      com_auth_email_max_length: 'אימייל לא צריך להיות ארוך מ-120 תווים',
      com_auth_email_pattern: 'עליך להזין כתובת אימייל חוקית',
      ...
      com_auth_password_forgot: 'שכחת סיסמה?',
      ...
      com_auth_error_create:
        'אירעה שגיאה בניסיון לרשום את החשבון שלך. בבקשה נסה שוב.',
      ...
      com_auth_reset_password_link_sent: 'אימייל נשלח',
      com_auth_reset_password_email_sent:
        'נשלח אליך הודעת דוא"ל עם הנחיות נוספות לאיפוס הסיסמה שלך.',
      com_auth_error_reset_password:
        'הייתה בעיה באיפוס הסיסמה שלך. לא נמצא משתמש עם כתובת האימייל שסופקה. בבקשה נסה שוב.',
      ...
      com_endpoint_google_topp:
        ...
        com_endpoint_instructions_assistants_placeholder:
          'עובר את הוראות העוזר. זה שימושי לשינוי ההתנהגות על בסיס ריצה.',
        com_endpoint_prompt_prefix_assistants_placeholder:
          'הגדר הוראות נוספות או הקשר על גבי ההנחיות הראשיות של ה-Assistant. התעלמו אם ריק.',
        ...
        com_endpoint_assistant: 'עוזר',
        com_endpoint_use_active_assistant: 'השתמש ב-Active Assistant',
        com_endpoint_assistant_model: 'מודל עוזר',
        ...
        com_endpoint_skip_hover:
          'אפשר דילוג על שלב ההשלמה, הסוקר את התשובה הסופית ואת השלבים שנוצרו',
        ...
        com_nav_plugin_auth_error:
          'אירעה שגיאה בניסיון לאמת את הפלאגין הזה. בבקשה נסה שוב.',
        ...
        com_nav_clear_all_chats: 'נקה את כל הצאטים',
        ...
        com_nav_lang_english: 'אנגלית',
        com_nav_lang_chinese: '中文',
        com_nav_lang_german: 'דויטש',
        ...
        com_nav_lang_indonesia: 'אינדונזיה',
};      

...
import CrackLanding from '~/components/ui/CrackLanding';
import CrackMessages from '~/components/Messages/CrackMessages';
import CrackTextChat from '~/components/Input/CrackTextChat';
...
export default function Crack() {
  ...
  return (
    <>
      {conversationId === 'new' && !messagesTree?.length ? <CrackLanding /> : <CrackMessages />}
      <CrackTextChat />
    </>
  );
}
